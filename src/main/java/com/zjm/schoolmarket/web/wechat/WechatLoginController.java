package com.zjm.schoolmarket.web.wechat;

import com.zjm.schoolmarket.dto.UserAccessToken;
import com.zjm.schoolmarket.dto.WechatAuthExecution;
import com.zjm.schoolmarket.dto.WechatUser;
...
import com.zjm.schoolmarket.util.wechat.WechatUtil;
 ...
 * 获取关注公众号之后的微信用户信息的接口，如果在微信浏览器里访问
   https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6404e9a05df1f5c3&redirect_uri=http://60.205.247.9/SchoolMarket/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
 * 则这里将会获取到code,之后再可以通过code获取到access_token 进而获取到用户信息
 *EncodingAESKey:5AM4k2UOQ0Ed4QyKXZIucCncj73nI0TT0uHWbViKI6g
 * @author xiangze
 *
 */
@Controller
