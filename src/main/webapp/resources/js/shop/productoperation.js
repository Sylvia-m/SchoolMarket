$(function() {
	...
	var infoUrl = '/SchoolMarket/shopadmin/getproductbyid?productId=' + productId;
	// 获取当前店铺设定的商品类别列表的URL
	var categoryUrl = '/SchoolMarket/shopadmin/getproductcategorylist';
	// 更新商品信息的URL
	var productPostUrl = '/SchoolMarket/shopadmin/modifyproduct';
	// 由于商品添加和编辑使用的是同一个页面，
	// 该标识符用来标明本次是添加还是编辑操作
	var isEdit = false;
	if (productId) {
		...
		getCategory();
		productPostUrl = '/SchoolMarket/shopadmin/addproduct';
	}
	...
	// 提交按钮的事件响应，分别对商品添加和编辑操作做不同响应//product.point = $('#point').val();
	$('#submit').click(
			function() {
