$(function() {
	// 获取此店铺下的商品列表的URL
	var listUrl = '/SchoolMarket/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
	// 商品下架URL
	var statusUrl = '/SchoolMarket/shopadmin/modifyproduct';
	getList();
	/**
	 * 获取此店铺下的商品列表
	 * 
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							...
							window.location.href = '/SchoolMarket/shopadmin/productoperation?productId='
							...
							window.location.href = '/SchoolMarket/frontend/productdetail?productId='
									+ e.currentTarget.dataset.id;
						}
					});
